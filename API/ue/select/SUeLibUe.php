...
if ($db) {
    $requete = $db->query("SELECT code_ue, libelle_ue, nature, ECTS, code_ue_pere, code_sem FROM ue WHERE libelle_ue LIKE '%" .$_POST['libelle_ue']. "%'
                                                                                                        or libelle_ue LIKE UPPER('%" .$_POST['libelle_ue']. "%')");
