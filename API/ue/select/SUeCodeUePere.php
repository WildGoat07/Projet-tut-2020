...
if ($db) {
    $requete = $db->query("SELECT code_ue, libelle_ue, nature, ECTS, code_ue_pere, code_sem FROM ue WHERE code_ue_pere LIKE '%" .$_POST['code_ue_pere']. "%'
                                                                                                        or code_ue_pere LIKE UPPER('%" .$_POST['code_ue_pere']. "%')");
