...
namespace DAO
{
    public interface ISemestreDAO
    {
        ...
        Task<Semestre[]> GetFilteredAsync(int maxCount, int page, string? orderBy = null, bool reverseOrder = false, IEnumerable<int>? number = null, IEnumerable<(string?, int?)>? step = null);
